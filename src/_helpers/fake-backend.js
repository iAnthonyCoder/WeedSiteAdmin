    ...
    window.fetch = function (url, opts) {
        return new Promise((resolve, reject) => {
            ...
            function register() {
                ...
                if (users.find(x => x.email === user.email)) {
                    ...
                    setTimeout(() => {
                        alertService.info(`
                            ...
                            <p>If you don't know your password please visit the <a href="http://localhost:3002/account/forgot-password">forgot password</a> page.</p>
                ...
                setTimeout(() => {
                    const verifyUrl = `http://localhost:3002/account/verify-email?token=${user.verificationToken}`;
                    alertService.info(`
            ...
            function forgotPassword() {
                ...
                setTimeout(() => {
                    const resetUrl = `http://localhost:3002/account/reset-password?token=${user.resetToken}`;
                    alertService.info(`
