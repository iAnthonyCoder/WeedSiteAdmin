...
function Table({ match }) {
    ...
    const _thisService=parentcategoryService
	...
	return (
		<>
	    	...
	    	<div className="box">
	    	  <MainTable ref={callApiTrigger} details={details} title={"PARENT CATEGORIES"} endPoint={parentcategoryService.getAll} columns={columns} scopeItem={scopeItem} deleteByID={deleteByID}/>
	    	</div>
		</>
	)
}
