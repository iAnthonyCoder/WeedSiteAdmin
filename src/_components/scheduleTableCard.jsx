           				...
           				<div className="modal-body">
             				<div className="row mb-3 align-items-end">
               					<div className="col">
               						...
               						<Field name="opens_at" type="number" placeholder="Enter opening time" className={'form-control' + (errors.opens_at && touched.opens_at ? ' is-invalid' : '')} />
             				...
             				<div className="row mb-3 align-items-end">
               					<div className="col">
               						...
               						<Field name="closes_at" type="number" placeholder="Enter closing time" className={'form-control' + (errors.closes_at && touched.closes_at ? ' is-invalid' : '')} />
                	...
                	<tbody>
                  	{
                    	...
                    	(
							<tr key={index}>
                      			...
                      			<td>{day.opens_at}:00</td>
                      			<td>{day.closes_at}:00</td>
