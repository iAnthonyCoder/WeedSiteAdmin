                    				...
                    				<ul className="dropdown-menu">
                    					...
                    					<li>
                    					  	<NavLink activeClassName="active" className="dropdown-item" to={'/admin/brands'}>
                    					  		<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z"></path><path d="M12 3l5 5a7 7 0 1 1 -10 0l5 -5"></path></svg>
                    					    	&nbsp;Brands
                    					  	</NavLink>
                    					</li>
                    					<li>
                    						<NavLink activeClassName="active" className="dropdown-item" to={'/admin/strains'}>
